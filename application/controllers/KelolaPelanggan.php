...
class KelolaPeserta extends MY_Controller {
  ...
  //  Method untuk menampilkan data
	...
	{
    $this->_dts['data_list'] =   $this->pelanggan->ambilData() ;// Proses pengambilan data dari database
  ...
  public function ubahData()
  {
    $this->_dts['data_pengguna'] = $this->pengguna->ambilData();
    $this->_dts['data_kota'] = $this->kota->ambilData();
    $this->_dts['detail'] = $this->pelanggan->ambilData($this->input->get('id')); // Ambil data yang akan diedit berdasarkan ID
