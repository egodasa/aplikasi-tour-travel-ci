...
@section('judul', 'Persyaratan Wisata Muslim')
                ...
                <div class="container">
                    <div class="row justify-content-between align-items-center d-flex">
                        <div class="col-lg-8 top-left">
                            <h1 class="text-white mb-20">Persyaratan Wisata Muslim</h1>
                            <ul>
                                ...
                                <li><a href="persyaratanumroh.html">Persyaratan Wisata Muslim</a></li>
                            </ul>
                        </div>
                    </div>
                </div>  
