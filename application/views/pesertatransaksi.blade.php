...
@section('title', 'Peserta Transaksi')
@section('sidebar_title', 'Peserta Transaksi')
@section('user_image', 'images/img.jpg')
@section('username', 'Mandan')
@section('content_title', 'Peserta Transaksi')
    ...
    <div class="modal-dialog">
      ...
      <div class="col-sm-6 col-xs-12">
        ...
        @if($_SESSION['level'] == 'Admin')
          @include('components.form.input', ['_data' => ['type' => 'text', 'name' => 'status', 'class' => 'form-control', 'max' => 50, 'label' => 'Status Peserta']])
        @else
          <input type="hidden" name="status" />
        @endif
        @include('components.form.input', ['_data' => ['type' => 'text', 'name' => 'keterangan', 'class' => 'form-control', 'max' => 50, 'label' => 'Keterangan']])
      </div>
    </div>
        </div>
