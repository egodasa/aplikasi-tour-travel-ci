...
@section('content')
	...
	@include('components.form.input', ['_data' => ['type' => 'text', 'name' => 'jenis_kelamin', 'class' => 'form-control', 'max' => 20, 'label' => 'Jenis Kelamin']])
	
    @include('components.form.select', ['_data' => [ 'name' => 'id_pengguna', 'value' => '','val' => 'id_pengguna', 'caption' => 'username','label' => 'Nama Pengguna', 'options' => []]])
	
	@include('components.form.input', ['_data' => ['type' => 'text', 'name' => 'no_identitas', 'class' => 'form-control', 'max' => 20, 'label' => 'No Identitas']])
    @include('components.form.input', ['_data' => ['type' => 'number', 'name' => 'tempat_lahir', 'class' => 'form-control', 'max' => 11, 'label' => 'Tempat Lahir']])
    ...
    @include('components.form.input', ['_data' => ['type' => 'number', 'name' => 'kel', 'class' => 'form-control', 'max' => 11, 'label' => 'Kelurahan']])
    ...
    @include('components.form.input', ['_data' => ['type' => 'text', 'name' => 'email', 'class' => 'form-control', 'max' => 20, 'label' => 'Email']])
    @include('components.form.input', ['_data' => ['type' => 'text', 'name' => 'warga_negara', 'class' => 'form-control', 'max' => 50, 'label' => 'Warga negara']])
    ...
    @include('components.form.input', ['_data' => ['type' => 'text', 'name' => 'jk_ahliwaris', 'class' => 'form-control', 'max' => 20, 'label' => 'Jenis Kelamin Ahli Waris']])
